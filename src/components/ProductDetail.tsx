...
const ProductDetail: React.FC = () => {
  ...
  return (
    <div className="p-8 h-full sm:flex flex-col text-center border border-black">
      ...
      <div className=" py-6 px-4">
        ...
        <button className="bg-green-700 border hover:bg-green-500 cursor-pointer p-3 text-white rounded-md hover:text-black">
          Comprar ahora
        </button>
      </div>
    </div>
